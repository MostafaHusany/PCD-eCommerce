<div class="text-center">
    ...
    @if(auth()->user()->hasRole('admin') || auth()->user()->isAbleTo('order_status_edit'))
    ...
    @if(auth()->user()->hasRole('admin') || auth()->user()->isAbleTo('order_status_delete'))
    <button class="delete-object btn btn-xs btn-danger" 
        data-object-id="{{$row_object->id}}" data-object-name="{{$row_object->status_name_en}}"
    >
