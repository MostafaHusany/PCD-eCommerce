<div style="display: none" id="editObjectsCard" class="card card-body">
    <div class="row">
        <div class="col-6">
            <h5>@lang('shippings.Update_Shipping')</h5>
        </div>
    ...
    <form action="/" id="objectForm">
        ...
        <div class="form-group row">
            <label for="edit-title" class="col-sm-2 col-form-label">@lang('shippings.Title')</label>
            <div class="col-sm-10">
                <input tabindex="1" type="text"  class="form-control" id="edit-title" placeholder="@lang('shippings.Title')">
        ...
        <div class="form-group row">
            <label for="edit-description" class="col-sm-2 col-form-label">@lang('shippings.Description')</label>
            <div class="col-sm-10">
                <textarea tabindex="2" class="form-control" id="edit-description" placeholder="@lang('shippings.Description')"></textarea>
        ...
        {{--
            <div class="form-group row">
                <label for="edit-cost_type" class="col-sm-2 col-form-label">@lang('shippings.Cost_Type')</label>
                <div class="col-sm-10">
        ...
        <div class="form-group row">
            <label for="edit-cost" class="col-sm-2 col-form-label">@lang('shippings.Cost_IN_SAR')</label>
            <div class="col-sm-10">
        ...
        <button tabindex="7" class="update-object btn btn-warning float-right">@lang('shippings.Update_Shipping')</button>
    </form>
</div>