            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header border-0">
                        <div class="row">
                            <div class="col-6">
                                <h3 class="card-title mt-2">@lang('dashboard.Orders_Status_Over') {{ Date('Y') }}</h3>
                            </div>
                            <div class="col-6">
                                <select name="" id="" class="form-control">
                                @for ($m=2022; $m<=2022; $m++) {
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header border-0">
                        <div class="row">
                            <div class="col-6">
                                <h3 class="card-title mt-2">@lang('dashboard.Orders_Status_Over') <b>{{ Date('M') }}</b></h3>
                            </div><!-- /.col-6 -->
                            <div class="col-6">
                                <select id="orderTypesMonth" class="form-control">
                                @for ($m=1; $m<=12; $m++) {
                                    <?php 
                                        $month = date('F', mktime(0,0,0,$m, 1, date('Y')));   
                                    ?>
            ...
            <div class="col-md-6">
                <div class="card card-boy">
                    <div class="card-header border-0">
                        <div class="row">
                            <div class="col-6">
                                <h3 class="card-title mt-2">@lang('dashboard.Top_Sold_Item_Over') <b>{{Date('Y')}}</b></h3>
                            </div><!-- /.col-6 -->
                            <div class="col-6">
                                <select name="" id="" class="form-control">
                                @for ($m=2022; $m<=2022; $m++) {
            ...
            <div class="col-md-6">
                <div class="card card-boy">
                    <div class="card-header border-0">
                        <div class="row">
                            <div class="col-6">
                                <h3 class="card-title mt-2">@lang('dashboard.Top_Sold_Item_Over') <b>{{ Date('M') }}</b></h3>
                            </div><!-- /.col-6 -->
                            <div class="col-6">
                                <select name="" id="" class="form-control">
                                @for ($m=1; $m<=12; $m++) {
            ...
            <div class="col-md-6">
                <div class="card card-boy">
                    <div class="card-header border-0">
                        <div class="row">
                            <div class="col-6">
                                <h3 class="card-title mt-2">@lang('dashboard.Top_Restored_Item_Over') <b>{{Date('Y')}}</b></h3>
                            </div><!-- /.col-6 -->
                            <div class="col-6">
                                <select name="" id="" class="form-control">
                                @for ($m=2022; $m<=2022; $m++) {
