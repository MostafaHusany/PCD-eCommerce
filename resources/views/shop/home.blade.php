                ...
                <div class="col-xl-3 d-none d-xl-block">
                    <div class="sale-banner">
                        <a class="hover_effect1" href="#">
                            <img src="{{asset('shop')}}/images/shop_banner_img6.jpg" alt="shop_banner_img6">
                        </a>
                    </div>
                </div>
                <div class="col-xl-9">
                                    ...
                                    <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "4"}}'>
                                            ...
                                            <div class="product_wrap">
                                                <div class="product_img">
                                                    <a href="shop-product-detail.html">
                                                        <img src="{{asset('shop')}}/images/el_img1.jpg" alt="el_img1">
                                                        <img class="product_hover_img" src="{{asset('shop')}}/images/el_hover_img1.jpg" alt="el_hover_img1">
                                                    </a>
                                        ...
                                        <div class="item">
                                            <div class="product_wrap">
                                                <div class="product_img">
                                                    <a href="shop-product-detail.html">
                                                        <img src="{{asset('shop')}}/images/el_img2.jpg" alt="el_img2">
                                                        <img class="product_hover_img" src="{{asset('shop')}}/images/el_hover_img2.jpg" alt="el_hover_img2">
                                                    </a>
                                                    <div class="product_action_box">
                                                        <ul class="list_none pr_action_btn">
                                                            <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                        ...
                                        <div class="item">
                                            <div class="product_wrap">
                                                ...
                                                <div class="product_img">
                                                    <a href="shop-product-detail.html">
                                                        <img src="{{asset('shop')}}/images/el_img3.jpg" alt="el_img3">
                                                        <img class="product_hover_img" src="{{asset('shop')}}/images/el_hover_img3.jpg" alt="el_hover_img3">
                                                    </a>
                                                    <div class="product_action_box">
                                                        <ul class="list_none pr_action_btn">
                                                            <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                        ...
                                        <div class="item">
                                            <div class="product_wrap">
                                                <div class="product_img">
                                                    <a href="shop-product-detail.html">
                                                        <img src="{{asset('shop')}}/images/el_img4.jpg" alt="el_img4">
                                                        <img class="product_hover_img" src="{{asset('shop')}}/images/el_hover_img4.jpg" alt="el_hover_img4">
                                                    </a>
                                                    <div class="product_action_box">
                                                        <ul class="list_none pr_action_btn">
                                                            <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                        ...
                                        <div class="item">
                                            <div class="product_wrap">
                                                <div class="product_img">
                                                    <a href="shop-product-detail.html">
                                                        <img src="{{asset('shop')}}/images/el_img5.jpg" alt="el_img5">
                                                        <img class="product_hover_img" src="{{asset('shop')}}/images/el_hover_img5.jpg" alt="el_hover_img5">
                                                    </a>
                                                    <div class="product_action_box">
                                                        <ul class="list_none pr_action_btn">
                                                            <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                        ...
                                        <div class="item">
                                            <div class="product_wrap">
                                                ...
                                                <div class="product_img">
                                                    <a href="shop-product-detail.html">
                                                        <img src="{{asset('shop')}}/images/el_img6.jpg" alt="el_img6">
                                                        <img class="product_hover_img" src="{{asset('shop')}}/images/el_hover_img6.jpg" alt="el_hover_img6">
                                                    </a>
                                                    <div class="product_action_box">
                                                        <ul class="list_none pr_action_btn">
                                                            <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                    ...
                                    <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "4"}}'>
                                        <div class="item">
                                            <div class="product_wrap">
                                                <div class="product_img">
                                                    <a href="shop-product-detail.html">
                                                        <img src="{{asset('shop')}}/images/el_img7.jpg" alt="el_img7">
                                                        <img class="product_hover_img" src="{{asset('shop')}}/images/el_hover_img7.jpg" alt="el_hover_img7">
                                                    </a>
                                                    <div class="product_action_box">
                                                        <ul class="list_none pr_action_btn">
                                                            <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                        ...
                                        <div class="item">
                                            <div class="product_wrap">
                                                ...
                                                <div class="product_img">
                                                    <a href="shop-product-detail.html">
                                                        <img src="{{asset('shop')}}/images/el_img8.jpg" alt="el_img8">
                                                        <img class="product_hover_img" src="{{asset('shop')}}/images/el_hover_img8.jpg" alt="el_hover_img8">
                                                    </a>
                                                    <div class="product_action_box">
                                                        <ul class="list_none pr_action_btn">
                                                            <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                        ...
                                        <div class="item">
                                            <div class="product_wrap">
                                                <div class="product_img">
                                                    <a href="shop-product-detail.html">
                                                        <img src="{{asset('shop')}}/images/el_img9.jpg" alt="el_img9">
                                                        <img class="product_hover_img" src="{{asset('shop')}}/images/el_hover_img9.jpg" alt="el_hover_img9">
                                                    </a>
                                                    <div class="product_action_box">
                                                        <ul class="list_none pr_action_btn">
                                                            <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                        ...
                                        <div class="item">
                                            <div class="product_wrap">
                                                ...
                                                <div class="product_img">
                                                    <a href="shop-product-detail.html">
                                                        <img src="{{asset('shop')}}/images/el_img10.jpg" alt="el_img10">
                                                        <img class="product_hover_img" src="{{asset('shop')}}/images/el_hover_img10.jpg" alt="el_hover_img10">
                                                    </a>
                                                    <div class="product_action_box">
                                                        <ul class="list_none pr_action_btn">
                                                            <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                        ...
                                        <div class="item">
                                            <div class="product_wrap">
                                                <div class="product_img">
                                                    <a href="shop-product-detail.html">
                                                        <img src="{{asset('shop')}}/images/el_img11.jpg" alt="el_img11">
                                                        <img class="product_hover_img" src="{{asset('shop')}}/images/el_hover_img11.jpg" alt="el_hover_img11">
                                                    </a>
                                                    <div class="product_action_box">
                                                        <ul class="list_none pr_action_btn">
                                                            <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                        ...
                                        <div class="item">
                                            <div class="product_wrap">
                                                <div class="product_img">
                                                    <a href="shop-product-detail.html">
                                                        <img src="{{asset('shop')}}/images/el_img12.jpg" alt="el_img12">
                                                        <img class="product_hover_img" src="{{asset('shop')}}/images/el_hover_img12.jpg" alt="el_hover_img12">
                                                    </a>
                                                    <div class="product_action_box">
                                                        <ul class="list_none pr_action_btn">
                                                            <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
        ...
        <div class="custom-container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="sale-banner mb-3 mb-md-4">
                        <a class="hover_effect1" href="#">
                            <img src="{{asset('shop')}}/images/shop_banner_img9.jpg" alt="shop_banner_img9">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="custom-container">
            <div class="row">
                <div class="col-xl-3 d-none d-xl-block">
                    <div class="sale-banner">
                        <a class="hover_effect1" href="#">
                            <img src="{{asset('shop')}}/images/shop_banner_img10.jpg" alt="shop_banner_img10">
                        </a>
                    </div>
                </div>
                <div class="col-xl-9">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="client_logo carousel_slider owl-carousel owl-theme nav_style3" data-dots="false" data-nav="true" data-margin="30" data-loop="true" data-autoplay="true" data-responsive='{"0":{"items": "2"}, "480":{"items": "3"}, "767":{"items": "4"}, "991":{"items": "5"}, "1199":{"items": "6"}}'>
                        <div class="item">
                            <div class="cl_logo">
                                <img src="{{asset('shop')}}/images/cl_logo1.png" alt="cl_logo" />
                            </div>
                        </div>
                        <div class="item">
                            <div class="cl_logo">
                                <img src="{{asset('shop')}}/images/cl_logo2.png" alt="cl_logo" />
                            </div>
                        </div>
                        <div class="item">
                            <div class="cl_logo">
                                <img src="{{asset('shop')}}/images/cl_logo3.png" alt="cl_logo" />
                            </div>
                        </div>
                        <div class="item">
                            <div class="cl_logo">
                                <img src="{{asset('shop')}}/images/cl_logo4.png" alt="cl_logo" />
                            </div>
                        </div>
                        <div class="item">
                            <div class="cl_logo">
                                <img src="{{asset('shop')}}/images/cl_logo5.png" alt="cl_logo" />
                            </div>
                        </div>
                        <div class="item">
                            <div class="cl_logo">
                                <img src="{{asset('shop')}}/images/cl_logo6.png" alt="cl_logo" />
                            </div>
                        </div>
                        <div class="item">
                            <div class="cl_logo">
                                <img src="{{asset('shop')}}/images/cl_logo7.png" alt="cl_logo" />
                            </div>
                        </div>
                    </div>
                </div>
