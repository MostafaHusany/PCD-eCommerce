...
<div class="wrap-breadcrumb">
    <ul>
        ...
        <li class="item-link"><a href="{{ url('/shop') }}" class="link">Shop</a></li>
        <li class="item-link"><span>{{ $target_product->en_name }}</span></li>
    </ul>
</div>
<div class="row">
    ...
    <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
        <div class="wrap-product-detail">
            <div class="detail-media">
                <div class="product-gallery">
                    <ul class="slides">
                        ...
                        <li data-thumb="{{ url('/') . '/' . $target_product->main_image }}">
                            <img src="{{ url('/') . '/' . $target_product->main_image }}" alt="product thumbnail" />
                        </li>
                    ...
                    <!-- <li data-thumb="{{ asset('shop_assets/images/products/digital_17.jpg') }}">
                        <img src="{{ asset('shop_assets/images/products/digital_17.jpg') }}" alt="product thumbnail" />
                    </li>
            ...
            <div class="detail-info">
                ...
                <h2 class="product-name">{{$target_product->en_name}}</h2>
                <div class="short-desc">
                    {{
                        $target_product->en_description
                    }}
                </div>
                <div class="wrap-social">
                    <a class="link-socail" href="#"><img src="assets/images/social-list.png" alt=""></a>
                </div>
                <div class="wrap-price"><span class="product-price">{{$target_product->en_name}} SR</span></div>
            ...
            <div class="advance-info">
                ...
                <div class="tab-contents">
                    <div class="tab-content-item active" id="description">
                        {{ $target_product->en_small_description }}
                    </div>
                    ...
                    <div class="tab-content-item " id="review">
                        <div class="wrap-review-form">
                            ...
                            <div id="comments">
                                <h2 class="woocommerce-Reviews-title">01 review for <span>{{ $target_product->en_name }}</span></h2>
                                <ol class="commentlist">
                                    <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                        <div id="comment-20" class="comment_container"> 
                                            <img alt="" src="{{ asset('shop_assets/images/author-avata.jpg') }}" height="80" width="80">
