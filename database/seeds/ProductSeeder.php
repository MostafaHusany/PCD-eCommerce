...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for ($i = 0; $i < $no_of_rows; $i++) {
            $category = array(
                'ar_name' => $fakerEn->unique()->realText(50),
                'en_name' => $fakerAr->unique()->realText(50),
                'ar_small_description' => $fakerEn->realText(200),
                'en_small_description' => $fakerAr->realText(200),
